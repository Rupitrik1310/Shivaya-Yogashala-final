...
export function ContactPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const selectedCourse = displayCourses.find(c => c.id === formData.courseId);
      const courseTitle = selectedCourse?.title || "Course not specified";
      ...
      try {
        ...
        console.error("⚠️ Email notification failed, but continuing with enrollment:", emailError);
      ...
      try {
        ...
        console.log("⚠️ Backend unavailable, enrollment saved locally only:", backendError);
      ...
      if (emailSent && backendSaved) {
        toast("Application submitted successfully! Email notification sent and data saved.");
      } else if (emailSent) {
        toast("Application submitted! Email notification sent. (Backend database unavailable but your application was received via email)");
      } else if (backendSaved) {
        toast("Application submitted and saved! (Email notification may have failed - we'll contact you soon)");
      } else {
        toast("Application received! Please also contact us via WhatsApp to confirm your enrollment.");
      }
      
    } catch (error) {
      console.error("Error submitting enrollment:", error);
      toast("Please contact us directly via WhatsApp or email to complete your enrollment.");
  ...
  const sendEmailNotification = async (data: typeof formData, courseTitle: string) => {
    try {
      ...
      if (emailResponse.ok) {
        ...
        console.error("❌ Email sending failed:", emailResponse.status, emailResult);
        ...
        <Card className="max-w-2xl mx-4 relative z-10">
          <CardContent className="p-12 text-center space-y-6">
            ...
            <p className="text-muted-foreground">
              Thank you for your interest in Shivaya Yogashala. We have received your application 
              and will contact you within 24-48 hours via email or WhatsApp.
            </p>
            <div className="space-y-3 pt-4 border-t border-primary/20 mt-6">
              <p className="text-lg text-secondary">ॐ नमः शिवाय</p>
              <p className="text-sm text-muted-foreground italic">Om Namaḥ Śivāya</p>
              <p className="text-xs text-muted-foreground">May Lord Shiva bless your yoga journey</p>
            </div>
  ...
  const displayCourses = courses.length > 0 ? courses : getFallbackCourses();
    ...
    <div className="relative min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-br from-primary/10 to-secondary/10 relative overflow-hidden">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Begin your transformative yoga journey with us. Fill out the application form 
            or reach out directly via WhatsApp or email. We are located in Rishikesh.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              <Card className="border-2 border-primary/20">
                <CardHeader>
                  <CardTitle className="text-primary">Enrollment Application</CardTitle>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="Complete Beginner">Complete Beginner (0-6 months)</SelectItem>
                            <SelectItem value="Beginner">Beginner (6 months - 1 year)</SelectItem>
                            <SelectItem value="Intermediate">Intermediate (1-3 years)</SelectItem>
                            <SelectItem value="Advanced">Advanced (3+ years)</SelectItem>
                            <SelectItem value="Teacher">Certified Teacher</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
                  ...
                  {step === 4 && (
                    <div className="space-y-4">
                      ...
                      <div className="bg-primary/5 p-4 rounded-lg text-sm">
                        <p className="mb-2"><strong>Review Your Application:</strong></p>
                        <p className="text-muted-foreground">Name: {formData.name}</p>
                        <p className="text-muted-foreground">Email: {formData.email}</p>
                        <p className="text-muted-foreground">Experience: {formData.experience}</p>
                      </div>
                    </div>
                  )}
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">WhatsApp Available 24/7</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
              ...
              <Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-secondary/5">
                <CardContent className="p-6 space-y-4">
                  <div className="text-center">
                    ...
                    <h3 className="text-primary mb-2">Quick Contact via WhatsApp</h3>
                ...
                <CardContent className="p-6 space-y-3">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Yoga Alliance Certified Programs</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary">✓</span>
                      <span>Experienced Teachers (10+ years)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary">✓</span>
                      <span>Authentic Traditional Training</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary">✓</span>
      ...
      <section className="py-20 bg-gradient-to-r from-primary/5 to-secondary/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-primary mb-4">Visit Our Ashram</h2>
            <p className="text-muted-foreground">Located in the spiritual heart of Rishikesh</p>
          </div>
          <div className="max-w-5xl mx-auto">
            <div className="aspect-video bg-gray-200 rounded-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3445.2234!2d78.3260!3d30.1167!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzDCsDA3JzAwLjEiTiA3OMKwMTknMzMuNiJF!5e0!3m2!1sen!2sin!4v1234567890"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
